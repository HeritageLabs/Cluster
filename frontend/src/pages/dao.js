...
import { donateTo, executeProposal, getDA0, getDA0Details, getProposals, isDAOMember, voteProposal } from "../utils/cluster";
...
const Dao = () => {
  ...
  const init = async () => {
    ...
    getProposals(res.address).then((p) => {
      setProposals(p);
    });
  }
                  ...
                  return (
                    ...
                    >
                      <Flex justifyContent="space-between" alignItems="center">
                        ...
                        <Text>{proposal.value + " EVMOS"}</Text>
                      </Flex>
                      <Divider my="10px" />
                      <Text ml="10px" color="brand.gray">
